...
import { Alert, Box, Group, NumberInput, Stack, Switch, Text } from '@mantine/core';
...
export function SettingsView() {
  ...
  return (
    <Stack gap={density.sectionGap} maw={density.contentMaxWidth}>
      <PageHeader
        title="Settings"
        subtitle="Applies to every candidate. You can still send now or cancel from any candidate."
      />

      <SectionCard
        title="Invite automations"
        description="Automatically send assessment and recorded-test invites after shortlisting."
      >
        <Stack gap="lg">
          <Stack gap="sm">
            <Switch
      ...
      <SectionCard
        title="Automatic screening decisions"
        description="Strong and weak candidates move forward or out without a click. Middling scores stay in Needs your review. Per-job shortlist threshold overrides the default minimum score below."
      >
        <Stack gap="md">
          <Switch
      ...
      <Box
        ...
        style={{
          marginInline: -4,
          borderRadius: 8,
          border: dirty ? `1px solid ${palette.accent}44` : `1px solid ${palette.border}`,
        }}
      >
        <Group justify="space-between" wrap="wrap">
          <Text size="sm" c={dirty ? undefined : 'dimmed'}>
